...
* [Frida](https://github.com/frida/frida) ⭐ 21,729 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,294 | 🐛 398 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,137 | 🐛 475 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,414 | 🐛 67 | 🌐 C++ | 📅 2026-08-18 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,729 | 🐛 4 | 🌐 Python | 📅 2026-08-21 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,156 | 🐛 200 | 🌐 C++ | 📅 2026-08-24 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,682 | 🐛 307 | 🌐 Python | 📅 2026-08-24 : System cleaner for Windows and Linux.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,960 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,488 | 🐛 14 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
* [Malheur](https://github.com/rieck/malheur) ⭐ 375 | 🐛 1 | 🌐 C | 📅 2019-05-08 : A tool for the automatic analyze of malware behavior.

### OS/VM

* [HiddenVM](https://github.com/aforensics/HiddenVM) ⭐ 2,676 | 🐛 21 | 🌐 Shell | 📅 2024-07-18 : Use any desktop OS without leaving a trace.
* [Tails](https://tails.boum.org/index.en.html) : portable operating system that protects against surveillance and censorship.

### Hardware

* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,628 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
