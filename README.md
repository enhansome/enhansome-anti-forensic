...
* [Frida](https://github.com/frida/frida) ⭐ 21,875 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,313 | 🐛 401 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,145 | 🐛 481 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,535 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,535 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [Peepdf](https://github.com/jesparza/peepdf) ⭐ 1,459 | 🐛 49 | 🌐 Python | 📅 2024-08-19 : A Python tool to explore PDF files in order to find out if the file can be harmful or not.
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,420 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,782 | 🐛 4 | 🌐 Python | 📅 2026-09-05 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,160 | 🐛 206 | 🌐 C++ | 📅 2026-09-08 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,849 | 🐛 313 | 🌐 Python | 📅 2026-09-09 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,057 | 🐛 83 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,481 | 🐛 104 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,974 | 🐛 18 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,164 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,886 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
...
* [tweetable-polyglot-png](https://github.com/DavidBuchanan314/tweetable-polyglot-png) ⭐ 2,608 | 🐛 2 | 🌐 Python | 📅 2021-08-11 : Pack up to 3MB of data into a tweetable PNG polyglot file.
* [Cloakify](https://github.com/TryCatchHCF/Cloakify) ⭐ 1,682 | 🐛 8 | 🌐 Python | 📅 2020-11-24 : Transforms any filetype into a list of harmless-looking strings. This lets you hide the file in plain sight, and transfer the file without triggering alerts.
...
* [Jsteg](https://github.com/lukechampine/jsteg) ⭐ 646 | 🐛 0 | 🌐 Go | 📅 2023-05-11 : jsteg is a package for hiding data inside jpeg files.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,502 | 🐛 14 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,641 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
...
* [BusKill](https://github.com/BusKill/buskill-app) ⭐ 315 | 🐛 62 | 🌐 Python | 📅 2026-07-19 : BusKill is an hardware and software project that uses a hardware tripwire/dead-man-switch to trigger a computer to lock or shutdown if the user is physically separated from their machine.
...
* [Lockup](https://github.com/levlesec/lockup) ⭐ 353 | 🐛 1 | 🌐 Java | 📅 2024-06-22 : A proof-of-concept Android application to detect and defeat some of the Cellebrite UFED forensic toolkit extraction techniques.
* [Ripple](https://github.com/guardianproject/ripple) ⭐ 294 | 🐛 17 | 🌐 Java | 📅 2026-04-17 : A "panic button" app for triggering a "ripple effect" across apps that are set up to respond to panic events.
