...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,938 | 🐛 106 | 📅 2026-08-21
...
* [Frida](https://github.com/frida/frida) ⭐ 21,695 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,718 | 🐛 3 | 🌐 Python | 📅 2026-08-21 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,157 | 🐛 206 | 🌐 C++ | 📅 2026-08-21 : Exif, Iptc and XMP metadata manipulation library and tools.
* [Scalpel](https://github.com/sleuthkit/scalpel) ⭐ 687 | 🐛 44 | 🌐 Shell | 📅 2024-03-27 : An open source data carving tool.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,666 | 🐛 305 | 🌐 Python | 📅 2026-08-22 : System cleaner for Windows and Linux.
...
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,473 | 🐛 101 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,954 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,155 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,624 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
