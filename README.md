...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,340 | 🐛 99 | 📅 2026-06-30
...
* [Frida](https://github.com/frida/frida) ⭐ 21,622 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,279 | 🐛 397 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,126 | 🐛 478 | 🌐 C | 📅 2026-08-11 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,404 | 🐛 73 | 🌐 C++ | 📅 2026-08-13 : Bulk Email and URL extraction tool.
...
* [Volafox](https://github.com/n0fate/volafox) ⭐ 174 | 🐛 1 | 🌐 Python | 📅 2016-07-25 : macOS Memory Analysis Toolkit.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,673 | 🐛 13 | 🌐 Python | 📅 2026-08-04 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,149 | 🐛 201 | 🌐 C++ | 📅 2026-08-13 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,563 | 🐛 308 | 🌐 Python | 📅 2026-08-10 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,047 | 🐛 84 | 🌐 C | 📅 2026-08-11 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,464 | 🐛 100 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [Silk-guardian](https://github.com/NateBrune/silk-guardian) ⭐ 722 | 🐛 8 | 🌐 C | 📅 2024-02-05 : An anti-forensic kill-switch that waits for a change on your usb ports and then wipes your ram, deletes precious files, and turns off your computer.
...
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,152 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [Tchunt-ng](https://github.com/antagon/TCHunt-ng) ⭐ 53 | 🐛 4 | 🌐 C | 📅 2018-11-09 : Reveal encrypted files stored on a filesystem.
...
* [stego-toolkit](https://github.com/DominicBreuker/stego-toolkit) ⭐ 2,682 | 🐛 17 | 🌐 Shell | 📅 2022-11-27 : This project is a Docker image useful for solving Steganography challenges as those you can find at CTF platforms.
...
* [Cloakify](https://github.com/TryCatchHCF/Cloakify) ⭐ 1,678 | 🐛 8 | 🌐 Python | 📅 2020-11-24 : Transforms any filetype into a list of harmless-looking strings. This lets you hide the file in plain sight, and transfer the file without triggering alerts.
...
* [StegaStamp](https://github.com/tancik/StegaStamp) ⭐ 873 | 🐛 36 | 🌐 Python | 📅 2023-12-08 : Invisible Hyperlinks in Physical Photographs.
* [Steganography](https://github.com/ragibson/Steganography) ⭐ 656 | 🐛 0 | 🌐 Python | 📅 2025-10-10 : Least Significant Bit Steganography for bitmap images (.bmp and .png), WAV sound files, and byte sequences.
...
* [Jsteg](https://github.com/lukechampine/jsteg) ⭐ 644 | 🐛 0 | 🌐 Go | 📅 2023-05-11 : jsteg is a package for hiding data inside jpeg files.
* [Stegdetect](https://github.com/abeluck/stegdetect) ⚠️ Archived : Automated tool for detecting steganographic content in images.
* [StegoVeritas](https://github.com/bannsec/stegoVeritas) ⭐ 409 | 🐛 6 | 🌐 Python | 📅 2026-04-10 : Yet another Stego Tool.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,486 | 🐛 13 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
* [Malheur](https://github.com/rieck/malheur) ⭐ 377 | 🐛 1 | 🌐 C | 📅 2019-05-08 : A tool for the automatic analyze of malware behavior.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,605 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
* [Day Tripper](https://github.com/dekuNukem/daytripper) ⭐ 4,037 | 🐛 6 | 🌐 C | 📅 2026-01-04 : Hide-My-Windows Laser Tripwire.
* [Silk Guardian](https://github.com/NateBrune/silk-guardian) ⭐ 722 | 🐛 8 | 🌐 C | 📅 2024-02-05 : Anti-forensic kill-switch that waits for a change on your usb ports and then wipes your ram, deletes precious files, and turns off your computer.
