...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,957 | 🐛 106 | 📅 2026-09-02
...
* [Frida](https://github.com/frida/frida) ⭐ 21,867 | 🐛 1,960 | 🌐 Meson | 📅 2026-09-07 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,313 | 🐛 400 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,145 | 🐛 480 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,533 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,533 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [PdfResurrect](https://github.com/enferex/pdfresurrect) ⭐ 104 | 🐛 1 | 🌐 C | 📅 2022-09-10 : A tool aimed at analyzing PDF documents.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,776 | 🐛 2 | 🌐 Python | 📅 2026-09-05 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,160 | 🐛 205 | 🌐 C++ | 📅 2026-09-06 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,825 | 🐛 311 | 🌐 Python | 📅 2026-09-07 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,055 | 🐛 83 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,479 | 🐛 103 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,969 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,163 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,882 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
* [stego-toolkit](https://github.com/DominicBreuker/stego-toolkit) ⭐ 2,689 | 🐛 17 | 🌐 Shell | 📅 2022-11-27 : This project is a Docker image useful for solving Steganography challenges as those you can find at CTF platforms.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,498 | 🐛 14 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [BusKill](https://github.com/BusKill/buskill-app) ⭐ 312 | 🐛 61 | 🌐 Python | 📅 2026-07-19 : BusKill is an hardware and software project that uses a hardware tripwire/dead-man-switch to trigger a computer to lock or shutdown if the user is physically separated from their machine.
