...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,928 | 🐛 100 | 📅 2026-06-30
...
* [Frida](https://github.com/frida/frida) ⭐ 21,649 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-17 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,286 | 🐛 398 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,129 | 🐛 475 | 🌐 C | 📅 2026-08-17 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,518 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,518 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,407 | 🐛 77 | 🌐 C++ | 📅 2026-08-17 : Bulk Email and URL extraction tool.
...
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,154 | 🐛 204 | 🌐 C++ | 📅 2026-08-17 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,599 | 🐛 313 | 🌐 Python | 📅 2026-08-17 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,046 | 🐛 82 | 🌐 C | 📅 2026-08-17 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,467 | 🐛 100 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,957 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,863 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
* [stego-toolkit](https://github.com/DominicBreuker/stego-toolkit) ⭐ 2,684 | 🐛 17 | 🌐 Shell | 📅 2022-11-27 : This project is a Docker image useful for solving Steganography challenges as those you can find at CTF platforms.
...
* [Steganography](https://github.com/ragibson/Steganography) ⭐ 659 | 🐛 0 | 🌐 Python | 📅 2025-10-10 : Least Significant Bit Steganography for bitmap images (.bmp and .png), WAV sound files, and byte sequences.
...
* [StegoVeritas](https://github.com/bannsec/stegoVeritas) ⭐ 410 | 🐛 6 | 🌐 Python | 📅 2026-04-10 : Yet another Stego Tool.
...
* [BusKill](https://github.com/BusKill/buskill-app) ⭐ 306 | 🐛 59 | 🌐 Python | 📅 2026-07-19 : BusKill is an hardware and software project that uses a hardware tripwire/dead-man-switch to trigger a computer to lock or shutdown if the user is physically separated from their machine.
