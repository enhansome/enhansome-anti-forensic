...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,422 | 🐛 107 | 📅 2026-09-02
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,351 | 🐛 404 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,156 | 🐛 482 | 🌐 C | 📅 2026-09-25 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Swap-digger](https://github.com/sevagas/swap_digger) ⭐ 535 | 🐛 1 | 🌐 Shell | 📅 2021-06-26 : A tool used to automate Linux swap analysis during post-exploitation or forensics.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,822 | 🐛 9 | 🌐 Python | 📅 2026-09-14 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,165 | 🐛 210 | 🌐 C++ | 📅 2026-09-25 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [Saruman](https://github.com/elfmaster/saruman) ⭐ 147 | 🐛 1 | 🌐 C | 📅 2026-09-24 : ELF anti-forensics exec, for injecting full dynamic executables into process image (With thread injection).
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,992 | 🐛 313 | 🌐 Python | 📅 2026-09-25 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,064 | 🐛 85 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,497 | 🐛 97 | 🌐 C | 📅 2026-09-23 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,993 | 🐛 18 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [StegaStamp](https://github.com/tancik/StegaStamp) ⭐ 883 | 🐛 36 | 🌐 Python | 📅 2023-12-08 : Invisible Hyperlinks in Physical Photographs.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,511 | 🐛 17 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [Ripple](https://github.com/guardianproject/ripple) ⭐ 297 | 🐛 17 | 🌐 Java | 📅 2026-04-17 : A "panic button" app for triggering a "ripple effect" across apps that are set up to respond to panic events.
