...
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,129 | 🐛 475 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,616 | 🐛 314 | 🌐 Python | 📅 2026-08-19 : System cleaner for Windows and Linux.
...
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,470 | 🐛 100 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,620 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
...
* [Lockup](https://github.com/levlesec/lockup) ⭐ 351 | 🐛 0 | 🌐 Java | 📅 2024-06-22 : A proof-of-concept Android application to detect and defeat some of the Cellebrite UFED forensic toolkit extraction techniques.
