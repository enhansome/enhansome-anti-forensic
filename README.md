...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,497 | 🐛 106 | 📅 2026-09-02
...
* [Frida](https://github.com/frida/frida) ⭐ 21,964 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,334 | 🐛 403 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,150 | 🐛 481 | 🌐 C | 📅 2026-09-17 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,808 | 🐛 8 | 🌐 Python | 📅 2026-09-14 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,163 | 🐛 207 | 🌐 C++ | 📅 2026-09-18 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,939 | 🐛 315 | 🌐 Python | 📅 2026-09-17 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,060 | 🐛 84 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,988 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [StegFS](https://github.com/albinoloverats/stegfs) ⭐ 29 | 🐛 0 | 🌐 C | 📅 2026-03-02 : A FUSE based steganographic file system.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,650 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
