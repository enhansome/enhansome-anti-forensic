...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,371 | 🐛 102 | 📅 2026-08-18
...
* [Frida](https://github.com/frida/frida) ⭐ 21,665 | 🐛 1,957 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,407 | 🐛 67 | 🌐 C++ | 📅 2026-08-18 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,691 | 🐛 15 | 🌐 Python | 📅 2026-08-04 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,155 | 🐛 204 | 🌐 C++ | 📅 2026-08-18 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,611 | 🐛 314 | 🌐 Python | 📅 2026-08-18 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,047 | 🐛 82 | 🌐 C | 📅 2026-08-17 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,469 | 🐛 100 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,864 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
