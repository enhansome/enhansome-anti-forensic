...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,613 | 🐛 106 | 📅 2026-09-02
...
* [Frida](https://github.com/frida/frida) ⭐ 21,991 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,346 | 🐛 404 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,154 | 🐛 481 | 🌐 C | 📅 2026-09-17 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [PcapXray](https://github.com/Srinivas11789/PcapXray) ⭐ 1,880 | 🐛 15 | 🌐 Python | 📅 2026-05-01 : Network Forensics Tool - To visualize a Packet Capture offline as a Network Diagram including device identification, highlight important communication and file extraction
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,423 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,811 | 🐛 9 | 🌐 Python | 📅 2026-09-14 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,165 | 🐛 209 | 🌐 C++ | 📅 2026-09-21 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,962 | 🐛 312 | 🌐 Python | 📅 2026-09-21 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,062 | 🐛 85 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,491 | 🐛 104 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,989 | 🐛 18 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [python-evtx](https://github.com/williballenthin/python-evtx) ⭐ 781 | 🐛 24 | 🌐 Python | 📅 2026-03-19 : A tool to parse the Windows XML Event Log (EVTX) format.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,895 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
...
* [tweetable-polyglot-png](https://github.com/DavidBuchanan314/tweetable-polyglot-png) ⭐ 2,612 | 🐛 2 | 🌐 Python | 📅 2021-08-11 : Pack up to 3MB of data into a tweetable PNG polyglot file.
...
* [StegaStamp](https://github.com/tancik/StegaStamp) ⭐ 881 | 🐛 36 | 🌐 Python | 📅 2023-12-08 : Invisible Hyperlinks in Physical Photographs.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,506 | 🐛 16 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,656 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
...
* [DoNotDisturb](https://github.com/objective-see/DoNotDisturb) ⭐ 329 | 🐛 29 | 🌐 Objective-C | 📅 2026-09-14 : Security tool for macOS that aims to detect unauthorized physical access to your laptop.
* [BusKill](https://github.com/BusKill/buskill-app) ⭐ 325 | 🐛 62 | 🌐 Python | 📅 2026-07-19 : BusKill is an hardware and software project that uses a hardware tripwire/dead-man-switch to trigger a computer to lock or shutdown if the user is physically separated from their machine.
