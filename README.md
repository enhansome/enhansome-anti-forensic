...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,741 | 🐛 100 | 📅 2026-06-30
...
* [Frida](https://github.com/frida/frida) ⭐ 21,625 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,278 | 🐛 398 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,126 | 🐛 479 | 🌐 C | 📅 2026-08-11 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,407 | 🐛 74 | 🌐 C++ | 📅 2026-08-14 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,678 | 🐛 14 | 🌐 Python | 📅 2026-08-04 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,151 | 🐛 201 | 🌐 C++ | 📅 2026-08-13 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,575 | 🐛 308 | 🌐 Python | 📅 2026-08-10 : System cleaner for Windows and Linux.
...
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,465 | 🐛 100 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [Steganography](https://github.com/ragibson/Steganography) ⭐ 657 | 🐛 0 | 🌐 Python | 📅 2025-10-10 : Least Significant Bit Steganography for bitmap images (.bmp and .png), WAV sound files, and byte sequences.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,609 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
