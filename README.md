...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,853 | 🐛 106 | 📅 2026-09-02
...
* [Frida](https://github.com/frida/frida) ⭐ 21,976 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,339 | 🐛 403 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,151 | 🐛 481 | 🌐 C | 📅 2026-09-17 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,163 | 🐛 206 | 🌐 C++ | 📅 2026-09-18 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,944 | 🐛 316 | 🌐 Python | 📅 2026-09-17 : System cleaner for Windows and Linux.
* [Meterpreter > clearev](https://github.com/rapid7/metasploit-payloads) ⭐ 2,060 | 🐛 85 | 🌐 C | 📅 2026-08-26 : The meterpreter clearev command will clear the Application, System, and Security logs on a Windows system.
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,488 | 🐛 104 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,989 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,168 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,505 | 🐛 16 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,652 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
...
* [BusKill](https://github.com/BusKill/buskill-app) ⭐ 323 | 🐛 62 | 🌐 Python | 📅 2026-07-19 : BusKill is an hardware and software project that uses a hardware tripwire/dead-man-switch to trigger a computer to lock or shutdown if the user is physically separated from their machine.
