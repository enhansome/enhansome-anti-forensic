...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,270 | 🐛 106 | 📅 2026-08-21
...
* [Frida](https://github.com/frida/frida) ⭐ 21,705 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,524 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,524 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,722 | 🐛 3 | 🌐 Python | 📅 2026-08-21 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,157 | 🐛 207 | 🌐 C++ | 📅 2026-08-21 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,673 | 🐛 306 | 🌐 Python | 📅 2026-08-23 : System cleaner for Windows and Linux.
...
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,475 | 🐛 101 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,958 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,626 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
