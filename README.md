...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,228 | 🐛 106 | 📅 2026-09-02
...
* [Frida](https://github.com/frida/frida) ⭐ 21,982 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,344 | 🐛 403 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,812 | 🐛 9 | 🌐 Python | 📅 2026-09-14 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,164 | 🐛 206 | 🌐 C++ | 📅 2026-09-18 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,952 | 🐛 313 | 🌐 Python | 📅 2026-09-20 : System cleaner for Windows and Linux.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,988 | 🐛 18 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,894 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,653 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
