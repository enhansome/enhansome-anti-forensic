...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,023 | 🐛 105 | 📅 2026-08-21
...
* [Frida](https://github.com/frida/frida) ⭐ 21,814 | 🐛 1,959 | 🌐 Meson | 📅 2026-09-01 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,140 | 🐛 479 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,528 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,528 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,761 | 🐛 5 | 🌐 Python | 📅 2026-08-21 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,158 | 🐛 204 | 🌐 C++ | 📅 2026-09-01 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,775 | 🐛 313 | 🌐 Python | 📅 2026-09-01 : System cleaner for Windows and Linux.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,880 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
...
* [steganography](https://github.com/7thSamurai/steganography) ⭐ 1,086 | 🐛 1 | 🌐 C++ | 📅 2024-05-10 : Simple C++ Image Steganography tool to encrypt and hide files insde images using Least-Significant-Bit encoding.
