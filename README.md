...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,599 | 🐛 105 | 📅 2026-08-21
...
* [Frida](https://github.com/frida/frida) ⭐ 21,690 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,290 | 🐛 398 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,135 | 🐛 475 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
* [Emldump](https://github.com/DidierStevens/DidierStevensSuite/blob/master/emldump.py) ⭐ 2,522 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Analyze MIME files.
* [Pdfid](https://github.com/DidierStevens/DidierStevensSuite/blob/master/pdfid.py) ⭐ 2,522 | 🐛 13 | 🌐 Python | 📅 2026-07-30 : Scan a file to look for certain PDF keywords.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,412 | 🐛 67 | 🌐 C++ | 📅 2026-08-18 : Bulk Email and URL extraction tool.
...
* [Exiftool](https://github.com/qazbnm456/awesome-web-security) ⭐ 13,714 | 🐛 2 | 🌐 Python | 📅 2026-08-21 : Reader and rewriter of EXIF informations that supports raw files.
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,156 | 🐛 200 | 🌐 C++ | 📅 2026-08-21 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,659 | 🐛 304 | 🌐 Python | 📅 2026-08-21 : System cleaner for Windows and Linux.
...
* [NTFS-3G](https://github.com/tuxera/ntfs-3g) ⭐ 1,472 | 🐛 101 | 🌐 C | 📅 2026-07-15 : NTFS-3G Safe Read/Write NTFS Driver.
...
* [Silk-guardian](https://github.com/NateBrune/silk-guardian) ⭐ 724 | 🐛 8 | 🌐 C | 📅 2024-02-05 : An anti-forensic kill-switch that waits for a change on your usb ports and then wipes your ram, deletes precious files, and turns off your computer.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,952 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
* [Mimipenguin](https://github.com/huntergregal/mimipenguin) ⭐ 4,154 | 🐛 6 | 🌐 C | 📅 2025-09-05 : A tool to dump the login password from the current linux user.
...
* [python-evtx](https://github.com/williballenthin/python-evtx) ⭐ 778 | 🐛 24 | 🌐 Python | 📅 2026-03-19 : A tool to parse the Windows XML Event Log (EVTX) format.
...
* [StegCloak](https://github.com/KuroLabs/stegcloak) ⭐ 3,866 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-01 : Hide secrets with invisible characters in plain text securely using passwords.
* [stego-toolkit](https://github.com/DominicBreuker/stego-toolkit) ⭐ 2,686 | 🐛 17 | 🌐 Shell | 📅 2022-11-27 : This project is a Docker image useful for solving Steganography challenges as those you can find at CTF platforms.
...
* [MalwareDetect](https://github.com/rfxn/linux-malware-detect) ⭐ 1,487 | 🐛 14 | 🌐 Shell | 📅 2026-05-24 : Submits a file's SHA1 sum to VirusTotal to determine whether it is a known piece of malware.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,619 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
* [Day Tripper](https://github.com/dekuNukem/daytripper) ⭐ 4,038 | 🐛 6 | 🌐 C | 📅 2026-01-04 : Hide-My-Windows Laser Tripwire.
* [Silk Guardian](https://github.com/NateBrune/silk-guardian) ⭐ 724 | 🐛 8 | 🌐 C | 📅 2024-02-05 : Anti-forensic kill-switch that waits for a change on your usb ports and then wipes your ram, deletes precious files, and turns off your computer.
