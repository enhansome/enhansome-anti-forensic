...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,579 | 🐛 106 | 📅 2026-08-21
...
* [Frida](https://github.com/frida/frida) ⭐ 21,723 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18 : Dynamic instrumentation toolkit for developers, reverse-engineers, and security researchers.
...
* [Autopsy](https://github.com/sleuthkit/autopsy) ⭐ 3,292 | 🐛 398 | 🌐 Java | 📅 2026-06-20 : The forensic browser. A GUI for the Sleuth Kit.
* [Sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,136 | 🐛 475 | 🌐 C | 📅 2026-08-19 : A library and collection of command line digital forensics tools that allow you to investigate volume and file system data.
...
* [Bulk-extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,413 | 🐛 67 | 🌐 C++ | 📅 2026-08-18 : Bulk Email and URL extraction tool.
...
* [Exiv2](https://github.com/Exiv2/exiv2) ⭐ 1,157 | 🐛 205 | 🌐 C++ | 📅 2026-08-24 : Exif, Iptc and XMP metadata manipulation library and tools.
...
* [BleachBit](https://github.com/bleachbit/bleachbit) ⭐ 6,680 | 🐛 306 | 🌐 Python | 📅 2026-08-24 : System cleaner for Windows and Linux.
...
* [lazagne](https://github.com/AlessandroZ/LaZagne) ⭐ 10,959 | 🐛 17 | 🌐 Python | 📅 2025-09-18 : An open source application used to retrieve lots of passwords stored on a local computer.
...
* [USB Kill](https://github.com/hephaest0s/usbkill) ⭐ 4,627 | 🐛 34 | 🌐 Python | 📅 2024-03-01 : Anti-forensic kill-switch that waits for a change on your USB ports and then immediately shuts down your computer.
